...
public class Logistic {
	 ...
	 public static void main(String[] args) {
	      ...
	      try{
	          ...
	          cfs1 = (Classifier)Class.forName("weka.classifiers.functions.Logistic").newInstance();
	          cfs2 = (Classifier)Class.forName("weka.classifiers.functions.Logistic").newInstance();
